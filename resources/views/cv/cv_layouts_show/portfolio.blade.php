    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 sumProject grid-container">
                @if(count($cv->portfolios) !== 0)
                    @foreach($cv->portfolios as $portfolio)
                        <div  id="project{{$portfolio->id}}" style="background: {{$portfolio->color_display}}" class="grid-item get-project position-relative item{{$portfolio->size_display}} show-box show-box-{{$portfolio->size_display}} box-1-1 flex justify-content-center align-items-center">
                    ...
                    <div class="modal-content">
                        ...
                        <form>
                            <div class="form-group col-md-12">
                                ...
                                <input readonly type="text" class="form-control" onblur="validateInfoModal(this.id, 0, 32)" id="nameProjectModal" placeholder="Name-project">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="customer-project-modal">Customer</label>
                                <input readonly type="text" class="form-control" onblur="validateInfoModal(this.id, 0, 32)" id="customerProjectModal" placeholder="Customer">
                            </div>
                            <div class="form-group flex">
                                <div class="form-group col-md-6 mb-0">
                                    <label for="time-end-project-modal">Time Start</label>
                                    <input readonly type="date" class="form-control" id="timeStartProjectModal" placeholder="Time Start">
                                </div>
                                <div class="form-group col-md-6 mb-0">
                                    <label for="time-start-project-modal">Time End</label>
                                    <input readonly type="date" class="form-control" id="timeEndProjectModal"  placeholder="Time End">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="description-project-modal">Description</label>
                                <input readonly type="text" class="form-control" onblur="validateInfoModal(this.id, 0, 100)" id="descriptionProjectModal" placeholder="Description">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="position-project-modal">Position</label>
                                <input readonly type="text" class="form-control" onblur="validateInfoModal(this.id, 0, 32)" id="positionProjectModal" placeholder="Position">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="responsibility-project-modal">Responsibility</label>
                                <input readonly type="text" class="form-control" onblur="validateInfoModal(this.id, 0, 32)" id="responsibilityProjectModal" placeholder="Responsibility">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="technology-project-modal">Technology</label>
                                <input readonly type="text" class="form-control" onblur="validateInfoModal(this.id, 0, 32)" id="technologyProjectModal" placeholder="Technology">
                            </div>
                            <div class="form-group flex">
                                <div class="form-group col-md-6 mb-0">
                                    <label for="team-size-modal">Team Size</label>
                                    <input readonly type="number" onblur="validateTeamSize(this.id, 1, 100)" class="form-control" id="teamSizeModal" placeholder="Team Size">
                                </div>
                                <div class="form-group col-md-6 mb-0">
                                    <label for="feature-project-modal">Feature select</label>
                                    <select aria-label="feature" disabled="true" class="form-control" id="featureProjectModal">
                                        <option id="featureModal" value="1">Feature</option>
                                        <option id="noneFeatureModal" value="0">None Feature</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group d-none flex">
                                <div class="form-group col-md-6 mb-0">
                                    <label for="feature-project-modal">Size Display</label>
                                    <select aria-label="size" disabled="true" class="form-control" id="sizeDisplayModal">
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <input readonly class="form-control" id="colorModal" type="color">
                                </div>
                            </div>
