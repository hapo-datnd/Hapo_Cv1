...
class UpdateCvRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'slides.*.content' => 'required|max:150',
            'content_slide_edit.*' => 'required|max:150',
            'image_slide_edit.*' => 'required|mimes:jpeg,png,jpg',
        ];
    }
    ...
    public function attributes()
    {
        return [
            ...
            'slides.*.content' => 'Content Slide',
            'image_slide_edit.*' => 'Avatar References',
        ];
    }
}
